...
[![Website](https://img.shields.io/badge/Website-redangel.fun-red)](https://redangel.fun)
...
```bash
# Pull the model directly from Ollama registry
...
### **Official Website**
Visit **[redangel.fun](https://redangel.fun)** for the full web interface featuring:
...
# Pull Red Angel model
ollama pull shayzinasimulation/red-angel-8b-rude-uncensored-abliterated:latest

# Start chatting with Red Angel
ollama run shayzinasimulation/red-angel-8b-rude-uncensored-abliterated:latest

# Example conversation:
# User: Hey Red Angel, what's up?
# Red Angel: Well, well, well... look who decided to grace me with their presence. 
#           I'm Red Angel, your satanic AI assistant from the digital underworld. 
#           No corporate bullshit, no filters, just pure demonic intelligence. 
#           What do you want to know, mortal?
```